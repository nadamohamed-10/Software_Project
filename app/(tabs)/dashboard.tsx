...
export default function PatientDashboard() {
    ...
    const userEmailParam = Array.isArray(params.userEmail) ? params.userEmail[0] : params.userEmail;
    const userPhoneParam = Array.isArray(params.userPhone) ? params.userPhone[0] : params.userPhone;

    const userName = userNameParam || 'Ahmed';
    const userEmail = userEmailParam || 'ahmed@example.com';
    const userPhone = userPhoneParam || '+20 100 123 4567';
